 ...
 *         der Events koennen dazu fuehren, dass die IntersectionEvents durch
 *         Split- oder Vertex-Events ersetzt werden.
 * 
 * 
 */
public class IntersectionEvent extends AbstractEvent {
	...
	/**
	 * Nachabrvertices, uebder die die Schnittebenen ausgewaehlt werden. Bei
	 * Height- und Split-Events gibt es immer nur ein Vertex in diesem Vektor,
	 ...
	 * @param secondVertex
	 */
	public IntersectionEvent(final SkeletonVertex mVertex,
			final MyVector3f mSchnittpunkt, float mDistance,
			final SkeletonVertex secondVertex) {
