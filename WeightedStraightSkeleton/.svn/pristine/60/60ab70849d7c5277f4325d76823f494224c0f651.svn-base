...
/**
 * 
 * @author Patrick Gunia Klasse zur Steuerung der Straight-Skeleton-Berechnung.
 *         Speichert Vertices, verschiedene Flags, Kantengewichte etc.
 * 
 */
...
public class SkeletonRoofDescriptor {
	...
	/**
	 * Liste enthaelt Kantengewichte in der Abfolge der Kanten, wie sie auch im
	 * Vertex-Vektor vorkommt
	 */
	private transient List<Float> mEdgeWeights = null;

	/**
	 * Stanardgewichtung fuer Kanten, sofern kein Gewicht uebergeben wird,
	 * verwendet dies als Kantengewicht
	 */
	...
	public void setVertices(final List<Vertex3d> mVertices) {
		...
		if (mEdgeWeights == null)
			computeStandardWeights();
	...
	// ------------------------------------------------------------------------------------------
	/**
	 * Methode berechnet fuer eine Vertex-Uebergabe Kantengewichte basierend auf
	 * dem in der Klasse festgelegten Standardwert
	 */
	...
	/**
	 * @param mSecondMainWeight
	 *            the mSecondMainWeight to set
	 */
	...
	/**
	 * @param mSecondSideWeight
	 *            the mSecondSideWeight to set
	 */
	...
	/**
	 * @param slopeChangeHeight
	 *            the mSlopeChangeHeight to set
	 */
	public void setSlopeChangeHeight(final Integer slopeChangeHeight) {
		...
		// aufgrund des Processing-Environments waechst das Dach in Richtung der
		// negativen y-Achse
		// die SlopeChangeHoehe ist relativ zum Dachgrundriss angegeben und muss
		// darum noch umgerechnet werden
