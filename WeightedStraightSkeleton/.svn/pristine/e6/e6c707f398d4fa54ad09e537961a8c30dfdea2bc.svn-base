...
public abstract class AbstractEvent implements iStraightSkeletonEvent {
	...
	/**
	 * Punkt, an dem das Event ausgeloest wurde, bei Split- und Edge-Events ein
	 * Schnittpunkt
	 */
	...
	/**
	 * Methode berechnet den Abstand zwischen Schnittpunkt und Vertex und damit
	 * die tatsaechliche Schrumpfdistanz
	 */
	...
	public String toString() {
		return "AbstractEvent [VertexPosition=" + mVertex.getPositionPtr()
				+ ", Schnittpunkt=" + mSchnittpunkt + ", Distance=" + mDistance
				+ ", Type=" + getType() + "]";
	}
	...
	public int hashCode() {
		...
		// result = prime * result + ((mVertex == null) ? 0 :
		// mVertex.hashCode());
		return result;
	}
