...
public class ChangeSlopeEvent extends AbstractEvent {
	 ...
	 * @param mDistance
	 */
	public ChangeSlopeEvent(final SkeletonVertex mVertex,
	...
	protected void calculateShrinkDistance() {
		...
		// berechne den Abstand der aktuellen Iterationsebene von der globalen
		// Zielhoehe, an der der Change-Event einsetzen soll
	...
	public String toString() {
		return "ChangeSlopeEvent: Distanz: " + mDistance + " Shrink-Distanz: "
				+ mShrinkDistance + mLineBreak;
	}
	// ------------------------------------------------------------------------------------------
