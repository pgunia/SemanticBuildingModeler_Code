 ...
 *        Anwendung. Dient der Verwaltung von dreidimensionalen Vektoren.
 * 
 */
...
public class MyVector3f extends Vector3f {
	...
	// ------------------------------------------------------------------------------------------
	/**
	 * Methode berechnet die Gleichheit zweier Vektoren innerhalb eines
	 * Toleranzbereichs
	 * 
	 * @param other
	 *            Vektor, fuer den ueberprueft werden soll, ob dieser Vektor mit
	 *            dem aktuellen Vektor uebereinstimmt
	 * @return True, falls der Abstand der durch die Vektoren beschriebenen
	 *         Punkte innerhalb eines Toleranzbereiches liegt, False sonst
	 */
	 ...
	 *            Vektor, fuer den ueberprueft werden soll, ob dieser Vektor mit
	 *            dem aktuellen Vektor uebereinstimmt
	 * @param maxAcceptableDifference
	 *            Maximale Abweichung unterhalb derer die Punkte als identisch
	 *            angesehen werden
	 * @return True, falls der Abstand der durch die Vektoren beschriebenen
	 *         Punkte innerhalb eines Toleranzbereiches liegt, False sonst
	 * 
	 */
	public boolean equalsWithinTolerance(final MyVector3f other,
			final float maxAcceptableDifference) {
	...
	// ------------------------------------------------------------------------------------------
	/**
	 * Methode fuehrt einen komponentenweisen Vergleich des Uebergabevektors mit
	 * dem aktuellen Vektor durch. Nur wenn alle Komponenten exakt
	 * uebereinstimmen (da es sich um floats handelt, muessen die Werte exakt
	 * uebereinstimmen), wird True zurueckgegeben, False sonst
	 * 
	 * @param comparable
	 *            Vektor, der mit dem aktuellen Vektor verglichen wird
	...
	// ------------------------------------------------------------------------------------------
	/**
	 * Methode testet, ob eine der Komponenten des Vektors NaN ist, falls dies
	 * der Fall ist, wird der Vektor als ungueltig betrachtet
	 * 
